...
现在远程工作时，任务都是写在 Teambition 里面的，每天工作之前，打开 Teambition来找到自己今天要做的任务，标记上进行中，完成之后，将标记改为已完成，并标记上完成用了多少时间，这样每完成一个任务就像在游戏中打败 BOSS 通过一关一样，让我感觉很有挑战性，也很有成就感。这种方式感觉比用番茄钟之类的高效的多。
